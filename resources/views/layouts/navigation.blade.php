    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('minimarket.manage_transactions.report')" :active="request()->routeIs('minimarket.manage_transactions.report')">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('minimarket.manager')" :active="request()->routeIs('minimarket.manager')">
                    {{ __('Sales Targets') }}
                </x-nav-link>
            </div>
